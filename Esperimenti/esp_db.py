"""
Esperimento atto SOLAMENTE a verificare il funzionamento del database. Questo file .py si occupa
della generazione del database di reGI.
"""
import os # per eliminare 
import sys
